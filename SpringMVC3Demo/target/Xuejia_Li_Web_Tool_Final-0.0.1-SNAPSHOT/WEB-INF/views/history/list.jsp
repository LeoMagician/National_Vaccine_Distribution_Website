...
<body class="page-header-fixed">
                  ...
                  <div class="portlet-body">
                     ...
                     <div class="dataTables_wrapper form-inline" role="grid">
	                     ...
	                     <c:import url = "../shared/paging.jsp">
	        				...
	        				<c:param name="urlAddress" value="/history/list"/>
	       				 </c:import>
       				 </div>
                  </div>
               </div>
   ...
   <script type="text/javascript">
         ...
         $(".table-toolbar").toolbarLite({
             items: [                 
                 { link: true, display: "View Details", css: "icon-shopping-cart", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/history/view/{0}", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>", 
                   	selector: "#data-table .checkboxes", mustSelect: "select first!", singleSelect: "Only support single select!"},
                 { splitter: true },                                 
                 { link: true, display: "Delete", css: "icon-trash", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/history/delete/{0}", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>", 
