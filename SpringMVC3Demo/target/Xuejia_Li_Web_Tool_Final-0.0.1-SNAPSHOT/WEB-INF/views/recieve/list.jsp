...
<body class="page-header-fixed">
   ...
   <script type="text/javascript">
         ...
         $(".table-toolbar").toolbarLite({
             items: [                 
                 { link: true, display: "Approve", css: "icon-ok", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/recieve/approve/{0}", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>", 
                   	selector: "#data-table .checkboxes", mustSelect: "select first!", singleSelect: "Only support single select!"},
                 { splitter: true },                                 
                 { link: true, display: "Reject", css: "icon-trash", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/recieve/reject/{0}", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>", 
