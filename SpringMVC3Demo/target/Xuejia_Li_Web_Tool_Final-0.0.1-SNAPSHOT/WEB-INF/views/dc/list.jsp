...
<body class="page-header-fixed">
                  ...
                  <div class="portlet-body">
                     ...
                     <div class="dataTables_wrapper form-inline" role="grid">
	                     ...
	                     <c:import url = "../shared/paging.jsp">
	        				...
	        				<c:param name="urlAddress" value="/dc/list"/>
	       				 </c:import>
       				 </div>
                  </div>
               </div>
   ...
   <script type="text/javascript">
         ...
         $(".table-toolbar").toolbarLite({
             items: [
                 { link: true, display: "Send Request", css: "icon-plus", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/dc/request", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>" },
                 { splitter: true },
                 { link: true, display: "Delete", css: "icon-trash", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/dc/delete/{0}", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>", 
