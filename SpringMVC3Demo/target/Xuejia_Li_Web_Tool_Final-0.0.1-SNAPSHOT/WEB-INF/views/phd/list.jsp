...
<body class="page-header-fixed">
   ...
   <script type="text/javascript">
         ...
         $(".table-toolbar").toolbarLite({
             items: [                 
                 { link: true, display: "Approve", css: "icon-shopping-cart", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/phd/approve/{0}", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>", 
                   	selector: "#data-table .checkboxes", mustSelect: "select first!", singleSelect: "Only support single select!"},
                 { splitter: true },                                 
                 { link: true, display: "Reject", css: "icon-remove", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/phd/reject/{0}", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>", 
