...
<body class="page-header-fixed">
      ...
      <div class="page-content">
         ...
         <div class="row">
            <div class="col-md-12">
               ...
               <h3 class="page-title">
                  Form Controls:<c:out value="${idsk}"/> <small>form controls and more</small>
               </h3>
                  ...
                  <div class="portlet-body">
                     ...
                     <div class="dataTables_wrapper form-inline" role="grid">
	                     ...
	                     <c:import url = "../shared/paging.jsp">
	        				...
	        				<c:param name="urlAddress" value="/registration/list"/>
	       				 </c:import>
       				 </div>
                  </div>
               </div>
   ...
   <script type="text/javascript">
         ...
         $(".table-toolbar").toolbarLite({
             items: [
                 { link: true, display: "Send Request", css: "icon-plus", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/registration/request", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>" },
                 { splitter: true },
                 { link: true, display: "Delete", css: "icon-trash", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/registration/delete/{0}", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>", 
