                     ...
                     <form:form modelAttribute="contentModel" class="form-horizontal" method="POST">
                        <div class="form-body">
                           <div class="form-group">
                              ...
                              <div class="col-md-10">
                                 <form:input path="name" class="form-control" placeholder="State Name"/><br/>
                                 <form:errors path="name" class="field-has-error"></form:errors>                                 
                              </div>                              
                           </div>
                         <div class="form-group">
                              <label  class="col-md-2 control-label">State Population</label>
                              <div class="col-md-10">
                                 <form:input path="population" class="form-control" placeholder="State Population"/><br/>
                                 <form:errors path="population" class="field-has-error"></form:errors>                                 
                           	  </div> 
                           </div>                             
                        </div>
