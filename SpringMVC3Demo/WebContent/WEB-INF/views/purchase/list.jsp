...
<body class="page-header-fixed">
      ...
      <div class="page-content">
         ...
         <div class="row">
            <div class="col-md-12">
               ...
               <h3 class="page-title">
                  Purchase <small>Welcome to national vaccine distribution system</small>
               </h3>
                  ...
                  <div class="portlet-body form">                  	 
                     ...
                     <div class="dataTables_wrapper form-inline" role="grid">
	                     ...
	                     <c:import url = "../shared/paging.jsp">
	        				...
	        				<c:param name="urlAddress" value="/purchase/list"/>
	       				 </c:import>
       				 </div>       				       				 
                  </div>                  
               </div>
   ...
   <script type="text/javascript">
         ...
         $(".table-toolbar").toolbarLite({
             items: [                 
                 { link: true, display: "Add to Cart", css: "icon-shopping-cart", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/purchase/add/{0}", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>", 
