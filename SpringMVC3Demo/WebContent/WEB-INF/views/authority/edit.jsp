                     ...
                     <form:form modelAttribute="contentModel" class="form-horizontal" method="POST">
                        <div class="form-body">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-10">
                                 <form:input path="position" class="form-control" placeholder="Position"/><br/>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-10">
                                 <form:input path="theValue" class="form-control" placeholder="Value"/>
                              </div>
                           </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-10">
                                 <form:input path="itemIcon" class="form-control" placeholder="Icon"/>
                              </div>
                           </div>
                           <div class="form-group">
                              <label  class="col-md-2 control-label">Belong to</label>
                              <div class="col-md-10">
                                 <div class="portlet">
