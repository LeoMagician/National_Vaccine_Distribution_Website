...
<body class="page-header-fixed">
            ...
            <div class="col-md-12">
				...
				<div class="portlet box light-grey">
				   <div class="portlet-title">
					  <div class="caption"><i class="icon-search"></i>User Search</div>
				   </div>
							...
							<div class="row">
							   <div class="col-md-6">
								  <div class="form-group">
									 ...
									 <div class="col-md-9">
										<form:input path="name" class="form-control placeholder-no-fix" autocomplete="off" placeholder="Your Name"/>
									 </div>
								  </div>
							   </div>
							   <!--/span-->
							   <div class="col-md-6">
								  <div class="form-group">
									 ...
									 <div class="col-md-9">
										<form:input path="username" class="form-control placeholder-no-fix" autocomplete="off" placeholder="Username"/>
									 </div>
								  </div>
							   </div>
							   <!--/span-->
   ...
   <script type="text/javascript">
         ...
         $(".table-toolbar").toolbarLite({
             items: [
                 { link: true, display: "Launch", css: "icon-ok", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/account/enable/{0}", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>",
                	 selector: "#data-table .checkboxes", mustSelect: "Select first!", singleSelect: "Only support single select!"},
                 { splitter: true }, 
                 { link: true, display: "Ban", css: "icon-remove", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/account/disable/{0}", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>", 
                 	 selector: "#data-table .checkboxes", mustSelect: "Select first!", singleSelect: "Only support single select!"},
                 { splitter: true }, 
                 { link: true, display: "Account Bind", css: "icon-user", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/account/authorize/{0}", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>", 
                   	 selector: "#data-table .checkboxes", mustSelect: "Select first!", singleSelect: "Only support single select!"},
                 { link: true, display: "Delete", css: "icon-trash", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/account/delete/{0}", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>", 
                   	 selector: "#data-table .checkboxes", mustSelect: "Select first!", confirm: "Confirm to delete selected data?"}
             ]
         });
      });
   </script>
