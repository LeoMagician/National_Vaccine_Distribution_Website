                     ...
                     <form:form modelAttribute="contentModel" class="form-horizontal" method="POST">
                        <div class="form-body">
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              <label  class="col-md-2 control-label">MFD</label>
                              <div class="col-md-10">
                                 <form:input path="mfd" class="form-control" placeholder="MFD"/><br/>
                                 <form:errors path="mfd" class="field-has-error"></form:errors>                                 
                              </div>                              
                           </div>
                           <div class="form-group">
                              <label  class="col-md-2 control-label">EXP</label>
                              <div class="col-md-10">
                                 <form:input path="exp" class="form-control" placeholder="EXP"/><br/>
                                 <form:errors path="exp" class="field-has-error"></form:errors>                                                                  
                              </div>                              
                           </div>
                           <div class="form-group">
                              <label  class="col-md-2 control-label">Vaccine Type</label>
                              <div class="col-md-10">
                                 <form:input path="vaccineType" class="form-control" placeholder="Vaccine Type"/><br/>
                                 <form:errors path="vaccineType" class="field-has-error"></form:errors>                                 
                              </div>                              
                           </div>
                           <div class="form-group">
                              <label  class="col-md-2 control-label">Availability</label>
                              <div class="col-md-10">
                                 <form:input path="availability" class="form-control" placeholder="Availability"/><br/>
                                 <form:errors path="availability" class="field-has-error"></form:errors>                                 
                              </div>                              
                           </div>
                         <div class="form-group">
                              <label  class="col-md-2 control-label">Vaccine Price</label>
                              <div class="col-md-10">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-10">
                                 <form:input path="disease" class="form-control" placeholder="Disease"/><br/>
                                 <form:errors path="disease" class="field-has-error"></form:errors>                                 
                              </div>                              
                           </div>                            
                        </div>
