...
import com.leo.service.models.VaccineSearch;
...
import com.leo.web.models.extension.VaccineModelExtension;
...
public class VaccineController extends BaseController{
	...
	public String list(HttpServletRequest request, Model model,@ModelAttribute VaccineSearch searchModel){
	...
	public String add(HttpServletRequest request, Model model){	
		if(!model.containsAttribute("contentModel"))
		{
			VaccineEditModel vaccineEditModel=new VaccineEditModel();
			model.addAttribute("contentModel", vaccineEditModel);
		}
    ...
    public String add(HttpServletRequest request, Model model, @Valid @ModelAttribute("contentModel") VaccineEditModel editModel, BindingResult result) throws EntityOperateException, ValidatException {
        if(result.hasErrors()){
            return add(request, model);
        }
        
        String returnUrl = ServletRequestUtils.getStringParameter(request, "returnUrl", null);
        Vaccine vaccine=VaccineModelExtension.toVaccine(editModel);
        vaccineService.save(vaccine);
        if(returnUrl==null)
        	returnUrl="production/list";
    	return "redirect:"+returnUrl;     	
    }
	...
	public String edit(HttpServletRequest request, Model model, @PathVariable(value="id") Integer id) throws ValidatException{	
		if(!model.containsAttribute("contentModel")){
			VaccineEditModel vaccineEditModel = VaccineModelExtension.toVaccineEdit(vaccineService.get(id));
			model.addAttribute("contentModel", vaccineEditModel);
		}		
    ...
    public String edit(HttpServletRequest request, Model model, @Valid @ModelAttribute("contentModel") VaccineEditModel editModel, @PathVariable(value="id") Integer id, BindingResult result) throws EntityOperateException, ValidatException {
        if(result.hasErrors())
