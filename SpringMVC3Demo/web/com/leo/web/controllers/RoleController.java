...
import com.leo.web.models.extension.RoleBindModelExtension;
import com.leo.web.models.extension.RoleModelExtension;
...
public class RoleController extends BaseController {  
	...
	public String bind(HttpServletRequest request, Model model, @PathVariable(value="id") Integer id) throws ValidatException{
		...
		List<TreeModel> treeModels=new ArrayList<TreeModel>(Arrays.asList(new TreeModel(null,null,"Root",false,false,false,children)));
	...
	public String enable(HttpServletRequest request, Model model, @PathVariable(value="id") Integer id) throws EntityOperateException, ValidatException{
	...
	public String edit(HttpServletRequest request, Model model, @PathVariable(value="id") Integer id) throws ValidatException{	
		if(!model.containsAttribute("contentModel")){
			RoleEditModel roleEditModel = RoleModelExtension.toRoleEdit(roleService.get(id));
			model.addAttribute("contentModel", roleEditModel);
		}		
    ...
    public String edit(HttpServletRequest request, Model model, @Valid @ModelAttribute("contentModel") RoleEditModel editModel, @PathVariable(value="id") Integer id, BindingResult result) throws EntityOperateException, ValidatException {
        if(result.hasErrors())
